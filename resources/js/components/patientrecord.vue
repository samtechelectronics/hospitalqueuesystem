                            ...
                            <div class="table-responsive">
                                ...
                                <table id="tableExample3" class="table table-striped table-hover">
                                    ...
                                    <tr v-for="data in record" :key="data.id">
                                        ...
                                        <td><router-link :to="{ name: 'recorddetails', params: {record_id: data.id } }" > <a href=""><i class="fa fa-eye"></i></a> </router-link></td>
                                    </tr>
        ...
        data(){
         ...
         getrecord(){
          this.token = "Bearer "  + localStorage.getItem('access_token');
               ...
               axios.post('/api/app/medicalhistory',{'doctor_id' : localStorage.getItem('id') , 'user_id' : this.$route.params.user_id }).then((response) => {
