     ...
     <div >
           ...
           <div class="row">
            <div class="col-md-12  grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">USERS Registered On this System</h4>
                  <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active alert alert-info" id="home-tab" data-toggle="tab" href="#home-1" role="tab" aria-controls="home-1" aria-selected="true">ALL Users</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link alert alert-info" id="profile-tab" data-toggle="tab" href="#profile-1" role="tab" aria-controls="profile-1" aria-selected="false">Patients</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link alert alert-info" id="contact-tab" data-toggle="tab" href="#contact-1" role="tab" aria-controls="contact-1" aria-selected="false">Front Desk</a>
                    </li>
                    <li class="nav-item" v-if="superadmincount != 0">
                      <a class="nav-link alert alert-info" id="contact-tab" data-toggle="tab" href="#contact-4" role="tab" aria-controls="contact-4" aria-selected="false" >Doctors</a>
                    </li>
                  </ul>
                    ...
                    <table class="table table-striped table-borderless">
                      ...
                      <tbody>
                        <tr v-for="user in allusers" :key="user.id" >
                          ...
                          <td v-if="user.level == 'member'" >Patient</td>
                          <td v-if="user.level == 'Super_admin'">Front Desk</td>
                          <td v-if="user.level == 'Admin'">Doctor</td>
                       
                          <td class="font-weight-medium text-success" >{{user.created_at}}</td>
                          <td><a href=""  v-on:click.prevent = "edituser(user)" data-toggle="tooltip" data-placement="bottom" title="Edit User" ><i class="fa fa-edit"></i></a> </td>
                        </tr>
                    ...
                    <table class="table table-striped table-borderless">
                      ...
                      <tbody>
                       <tr v-for="member in members" :key="member.id" >
                          ...
                          <td><a href="" v-on:click.prevent = "edituser(member)" data-toggle="tooltip" data-placement="bottom" title="Edit User" ><i class="fa fa-edit"></i></a>  </td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table class="table table-striped table-borderless">
                      ...
                      <tbody>
                       <tr v-for="admin in admins" :key="admin.id" >
                          ...
                          <td><a href=""v-on:click.prevent = "edituser(admin)" data-toggle="tooltip" data-placement="bottom" title="Edit User"><i class="fa fa-edit"></i></a> </td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table class="table table-striped table-borderless">
                      ...
                      <tbody>
                       <tr v-for="superadmin in superadmins" :key="superadmin.id" >
                          ...
                          <td><a href="" v-on:click.prevent = 'edituser(superadmin)'  data-toggle="tooltip" data-placement="bottom" title="Edit User" ><i class="fa fa-edit"></i></a>  </td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                          ...
                          <!-- <has-error :form="form" field="product_name" ></has-error> -->
                           ...
                           <div class="form-group" >
                             ...
                             <div class="form-group" >
                              ...
                              <option   value="Super_admin">Doctor</option>
         ...
         loaddata(){
          // console.log("ok oo");
            this.token = "Bearer "  + localStorage.getItem('access_token');
                ...
                // localStorage.setItem('access_token', data.access_token);
                   axios.get('/api/app/getusers').then((response) => {
                       console.log(response.data);
                      if(response.data.code == undefined){
                   // window.location.href = '/signin'; 
                      }
